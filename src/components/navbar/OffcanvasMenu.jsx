...
//       title: 'Resources',
//       items: [
//         { icon: BookOpen, title: 'Case Studies', href: '#cases' },
//         { icon: Users, title: 'About Us', href: '#about' },
//         { icon: FileCheck, title: 'IT Health Check', href: '#health-check' }
//       ]
//     }
//   ];
...
//             exit={{ x: '100%' }}
//             transition={{ type: 'spring', damping: 30, stiffness: 300 }}
//             className="fixed right-0 top-0 h-full w-full max-w-md bg-slate-900 border-l border-white/10 z-50 flex flex-col overflow-hidden"
//           >
//             {/* Header */}
//             <div className="sticky top-0 bg-slate-900/95 backdrop-blur-xl border-b border-white/10 p-6 flex items-center justify-between">
//               <div className="flex items-center gap-3">
...
//                   href={link.href}
//                   onClick={onClose}
//                   className="block py-3 text-white font-semibold hover:text-blue-400 transition-colors border-b border-white/5"
//                 >
//                   {link.title}
//                 </a>
//               ))}
